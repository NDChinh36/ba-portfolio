...
<AccordionGroup>
  <Accordion title="[Sprint 1] Xác nhận ngưỡng Confidence Score với Compliance & Risk" icon="chart-bar">
  ...
  <Accordion title="[Sprint 1] Policy rút tiền trong Grace Period — CCCD hết hạn & Freeze" icon="wallet">
  ...
  <Accordion title="[Sprint 1] Thông báo User cũ khi phát hiện CCCD trùng" icon="bell">
  ...
  <Accordion title="[Sprint 1] Quyết định iProov SDK — Native vs Web" icon="mobile">
  ...
  <Accordion title="[Sprint 2] Quy trình KYC Tier 3 — Full KYC / Business Account" icon="building">
  ...
  <Accordion title="[Sprint 2] Quy trình Manual Review khi NFC Chip hỏng" icon="clipboard-check">
