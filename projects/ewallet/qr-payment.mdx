...
### 12.1 Chi tiết request/response
...
// Request
{
  "raw_qr": "00020101021126440010A000000727...63043E74"
}

// Response — VietQR tĩnh
{
  "type": "vietqr",
  "is_dynamic": false,
  "bank": {
    ...
    "short_name": "MBBank",
    "logo_url": "https://cdn.ewallet.vn/banks/mbbank.png"
  },
...
// Response — VietQR động
{
  "type": "vietqr",
  "is_dynamic": true,
  "bank": { "bin": "970403", "name": "MBBank", ... },
  "account_no": "001234567890",
  "account_name": "NGUYEN VAN A",
  "amount": 150000,
  "description": "Thanh toan bua com",
  "merchant_ref": "ORDER_2026_001234",
  "raw_payload_valid": true
}

// Response — QR nội bộ ví
{
  "type": "internal",
  "redirect": "ewallet://transfer?user_id=USR_789"
}

// Response — Lỗi
{
  "error": "QR_001",
  "message": "Mã QR không được hỗ trợ"
}
```
...
// Request
{
  ...
  "account_name": "NGUYEN VAN A",
  "amount": 150000,
  "description": "Thanh toan bua an",
  "qr_type": "static",
  "auth_method": "biometric",
  "bio_session_token": "bio_abc123xyz"
}
...
// Response — Thất bại
{
  "status": "FAILED",
  "error": "QR_010",
  "message": "Ngân hàng thụ hưởng không thể nhận tiền lúc này. Vui lòng thử lại sau.",
  "tx_id": "TXN-QR-2026-000456",
