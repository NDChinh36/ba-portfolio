...
<AccordionGroup>
  <Accordion title="[Sprint 7] NAPAS Account Name Lookup trước khi Confirm QR Payment" icon="user-check">
  ...
  <Accordion title="[Sprint 7] Fee Model cho QR Payment" icon="coins">
  ...
  <Accordion title="[Sprint 7] Giới hạn số Dynamic QR tạo trong ngày" icon="qrcode">
  ...
  <Accordion title="[Sprint 7] Kiến trúc NAPAS Callback — Webhook vs Polling" icon="server">
  ...
  <Accordion title="[Sprint 8] Lịch sử QR Merchant đã quét — One-tap Rescan" icon="clock-rotate-left">
