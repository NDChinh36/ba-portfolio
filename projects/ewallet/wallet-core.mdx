...
| BR-WALLET-14 | **LimitEngine bucket riêng per operation type:** TOPUP, WITHDRAWAL, TRANSFER, QR_PAY mỗi loại có counter ngày/tháng riêng biệt; không cộng gộp. Ví dụ: user chuyển 90M (gần limit TRANSFER) vẫn có thể nạp thêm 100M (bucket TOPUP còn nguyên) | Limit Engine |
