...
<AccordionGroup>
  <Accordion title="[Sprint 1] Đăng ký đa phương thức — Email + SĐT" icon="envelope">
  ...
  <Accordion title="[Sprint 1] Xác thực Biometric nâng cao — FIDO2 / WebAuthn" icon="fingerprint">
  ...
  <Accordion title="[Sprint 1] Chính sách Quên PIN khi tài khoản đang bị khóa" icon="key">
  ...
  <Accordion title="[Sprint 2] Fallback OTP qua Voice Call" icon="phone">
  ...
  <Accordion title="[Sprint 2] Xác thực PIN trước khi Đăng xuất tất cả thiết bị" icon="shield-halved">
  ...
  <Accordion title="[Sprint 2] Cấu hình thời gian Auto-Logout per User" icon="clock">
