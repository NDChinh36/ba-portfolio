---
title: "User Stories & AC"
description: "US-MOMO-TRANSFER-001 | User Stories với Given/When/Then Acceptance Criteria"
icon: "user"
---
...
| Trường hợp | Hành vi mong đợi |
|---|---|
| cumulative\_1h vượt ngưỡng đúng tại thời điểm xác thực (do GD khác vừa thành công song song) | Nâng bậc auth realtime; yêu cầu OTP thêm |
...
- [ ] cumulative\_1h tính đúng trong môi trường concurrent
...
| Sender mất mạng ngay sau khi confirm | Khi reconnect, check idempotency\_key → trả kết quả GD đã tồn tại |
| Recipient không nhận được notification | GD vẫn hợp lệ; recipient xem trong lịch sử; retry notification lên đến 3 lần |

**Definition of Done:**
- [ ] Tất cả AC pass
- [ ] Test idempotency: gửi cùng idempotency\_key 2 lần → chỉ 1 GD được tạo
