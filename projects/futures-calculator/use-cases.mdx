---
title: "Use Case Specification — Futures Calculator"
description: "UC-FUTURES-CALC-001 | Use Case Specification"
...
| 9 | Hệ thống | — | Thực hiện tính toán phía client theo công thức:<br/>- **Long PnL** = Size×(Exit−Entry) − Size×Exit×f − Size×Entry×f<br/>- **Short PnL** = −(Size×(Exit−Entry) − Size×Exit×f − Size×Entry×f)<br/>- **IM** = Size×Entry÷Leverage |
...
| 9 | Hệ thống | — | Tính Target Price theo công thức (Long có Quantity):<br/>**Target Price** = (PnL + Entry×(Size + Size×f)) ÷ (Size − Size×f) |
...
| 7 | Hệ thống | — | Tính Liquidation Price theo công thức (Long):<br/>**Liq Price** = Entry×(1 + f − 1÷L) ÷ (1 − f)<br/>Trong đó: f = fee rate, L = leverage |
